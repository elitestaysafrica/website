...
const modules = [
  {
    num: 1,
    title: "Understanding STRs & Choosing Your Path",
    videos: 4,
    desc: "STR vs Airbnb, ways to make money, model pros and cons, location choices, deal math, red flags, and choosing your path.",
  },
  {
    num: 2,
    title: "Furnishing & Setting Up",
    videos: 6,
    desc: "Setup principles, budgeting, room-by-room furnishing, essentials, 5-star touches, inventory, photography, and pre-launch walkthrough.",
  },
  {
    num: 3,
    title: "Listing That Converts",
    videos: 5,
    desc: "What a listing must do, selling angles, photo order, title formula, descriptions, amenities, rules, trust signals, and listing review.",
  },
  {
    num: 4,
    title: "Getting Guests: Airbnb + Off-Airbnb",
    videos: 6,
    desc: "Airbnb optimization, direct bookings, corporate/monthly guests, WhatsApp groups, agents, referrals, channel rules, and acquisition planning.",
  },
  {
    num: 5,
    title: "Pricing & Launch",
    videos: 6,
    desc: "Rule of 10, pricing floor, launch strategy, seasonal/event pricing, minimum stays, discounts, occupancy vs ADR, and monthly reviews.",
  },
  {
    num: 6,
    title: "Cleaning & Turnover",
    videos: 6,
    desc: "5-star cleaning standards, checklists, cleaner training, turnover flow, linen/laundry, restocking, quality control, and backup plans.",
  },
  {
    num: 7,
    title: "Guest Experience & Communication",
    videos: 5,
    desc: "Guest journey, expectations, message templates, check-in, during-stay support, complaints, checkout, reviews, and repeat guests.",
  },
  {
    num: 8,
    title: "Protection & Problem Solving",
    videos: 6,
    desc: "Airbnb vs direct booking reality, guest vetting, protection fees, house rules, evidence, broken items, parties, refunds, reviews, and insurance.",
  },
  {
    num: 9,
    title: "Finance, Reporting & Scaling",
    videos: 6,
    desc: "Revenue vs profit, monthly reviews, owner reporting, when to scale, what breaks, SOPs, support, scaling models, and case studies.",
  },
  {
    num: 10,
    title: "Your STR Launch Blueprint",
    videos: 5,
    desc: "Choose your path, map the four launch models, build your 30/60/90-day plan, use the templates, and become a professional operator.",
  },
]
